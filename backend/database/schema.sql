...
CREATE TABLE projects (
  ...
  is_cost_involved TINYINT(1) NOT NULL DEFAULT 0,
  cost_value DECIMAL(12, 2) NULL,
  cost_approved TINYINT(1) NULL,
  cost_approval_document TEXT NULL,
  client_type ENUM('Existing Client', 'New Client', 'POC') NOT NULL DEFAULT 'Existing Client',
  project_status ENUM('Yet to Start', 'In-Progress', 'On Hold', 'Cancelled') NOT NULL DEFAULT 'Yet to Start',
